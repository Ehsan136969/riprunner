...
class SystemConfigModel extends BaseViewModel {
    ...
    private static $filter_ignore_constants = array('INCLUSION_PERMITTED',
            ...
            'DEFAULT_SMS_PROVIDER_TWILIO_FROM', 'DEFAULT_SMS_PROVIDER_KAVENEGAR_BASE_URL',
            'DEFAULT_SMS_PROVIDER_KAVENEGAR_API_KEY', 'DEFAULT_SMS_PROVIDER_KAVENEGAR_FROM',
            'DEFAULT_GCM_API_KEY', 'DEFAULT_GCM_PROJECTID', 'DEFAULT_GCM_APPLICATIONID',
            'DEFAULT_GCM_SAM', 'DEFAULT_WEBSITE_GOOGLE_MAP_API_KEY',
